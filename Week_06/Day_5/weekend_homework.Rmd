...
null_distribution %>%
  visualise(bins = 30) +
  shade_p_value(obs_stat = observed_stat$proportion, direction = "left")

null_distribution %>%
  get_p_value(obs_stat = observed_stat$proportion, direction = "left")
```
reject H0, accept H1.
...
H1: Anything other than 40% of people know the shop
Method: bootstrap?
...
H0: µtop_banner > 0.5
HA: µtop_banner <= 0.5
H0: More folk click the top banner
H1: less or equal folk click the top banner in comparison to the side banner
Method: Permutation
...
We reject our null hypothesis and therefore determine our bosses statement to be
inaccurate.
...
We fail to reject H0, suggesting more than 50% of people clicked the top banner
more often than the side banner.
...
We reject H0, therefore accepting HA, suggesting the process has drifted 
significantly.